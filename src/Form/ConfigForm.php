...
namespace Drupal\menu_item_group_role_access\Form;

use Drupal\Core\Form\ConfigFormBase;
use Drupal\Core\Form\FormStateInterface;

/**
 * Provides a configuration form for the Menu Item Group Role Access module.
 */
class ConfigForm extends ConfigFormBase {
  ...
  protected function getEditableConfigNames() {
    return [
      'menu_item_group_role_access.config',
    ];
  }
  ...
  public function getFormId() {
    return 'menu_item_group_role_access_config';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('menu_item_group_role_access.config');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('menu_item_group_role_access.config')
